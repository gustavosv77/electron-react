    ...
    >
      ...
      >
        ...
        <FormControl mt={4}>
          ...
          <Input type="password" placeholder="Confirme sua nova senha" padding={"0.6rem"} width={"20rem"} borderRadius={"0.6rem"} onChange={(e)=>{setConfirmNewPassword(e.target.value)}}/>
        </FormControl>
    <Flex gap={"2.5rem"}>   
      <Button
        padding={"1rem 2.5rem"}
